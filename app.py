...
REGION_LANG = {
    ...
    "BD":"bn","PK":"ur","TW":"zh","ru","SAC":"es","BR":"pt"
}
ALL_REGIONS = list(REGION_LANG.keys())
SUPPORTED_REGIONS = {"IND","BR","US","SAC","NA","SG","RU","ID","TW","VN","TH","ME","PK","BD","EUROPE"}
...
_SERVICE_ACCOUNTS = {
    ...
    "BD": {"uid":"7563445849","password":"ahaijshs_5Q04R_xSaeed_LY2EZ"},
...
def route_friend_add():
    ...
    Optional: &region=IND|SG|ID|BR|ME|VN|TH|PK|US|RU|TW
    """
